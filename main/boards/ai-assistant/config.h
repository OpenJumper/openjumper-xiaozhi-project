...
// 音量控制按钮
#define VOLUME_UP_BUTTON_GPIO   GPIO_NUM_39  // 音量增加按钮
#define VOLUME_DOWN_BUTTON_GPIO GPIO_NUM_40  // 音量减小按钮
...
// 显示屏参数配置
#define DISPLAY_WIDTH    240        // 显示屏宽度
#define DISPLAY_HEIGHT   240        // 显示屏高度
...
#define CAR_UART_BAUD_RATE  9600          // 波特率9600
